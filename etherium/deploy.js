...
const campanhaFactory = require('./build/CampanhaFactory');
...
const deploy = async () => {
    ...
    const result = await new web3.eth.Contract(JSON.parse(campanhaFactory.interface))
      .deploy({ data: '0x' + campanhaFactory.bytecode })
